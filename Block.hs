...
data Block a
  = Stuff a
  | Blank                      -- fits any size
  | Vert (Layout a) (Layout a)  -- should both have the right width
...
boxLayout boxa (xy, Vert lb rb)  = boxLayout boxa lb ++ boxLayout boxa rb
...
joinH b1@((x1, y1), _) b2@((x2, y2), _)
  ...
  | y1 < y2
  = ((x1 + x2, y2), Hor ((x1, y2), Vert b1 ((x1, y2 - y1), Blank)) b2)
  | y1 > y2
  = ((x1 + x2, y1), Hor b1 ((x2, y1), Vert b2 ((x2, y1 - y2), Blank)))

joinV :: Layout a -> Layout a -> Layout a
joinV b1@((x1, y1), _) b2@((x2, y2), _)
  | x1 == x2 = ((x1, y1 + y2), Vert b1 b2)
  | x1 < x2
  = ((x2, y1 + y2), Vert ((x2, y1), Hor b1 ((x2 - x1, y1), Blank)) b2)
  | x1 > x2
  = ((x1, y1 + y2), Vert b1 ((x1, y2), Hor b2 ((x1 - x2, y2), Blank)))
